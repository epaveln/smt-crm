...
var $addTagLink = $('<a class="btn btn-outline-secondary add_tag_link-email" href="#">' +
    '                    <i class="fas fa-plus-circle"></i>  Прикрепить файл' +
    '                </a>');
...
jQuery(document).ready(function() {
    ...
    var id = $("#offer_form_contractor").attr("contractorId");
    $("#offer_form_contractor > option[value="+id+"]").attr("selected", "selected");
